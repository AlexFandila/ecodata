...
- El hook pre-commit (se instala en la Fase 0) es el suelo: lint + typecheck + escaneo de IBANs sobre lo staged, por si algún día tú o Claude os saltáis el ritual.
